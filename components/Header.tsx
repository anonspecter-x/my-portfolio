...
// 📌 Mobile menu should always show Home if not on Home page + added Terminal link
  ...
  >
    ...
    >
      ...
      <nav className="hidden md:flex items-center text-[13px] font-bold text-gray-500 dark:text-gray-400 relative">
        ...
        {/* 🏠 Left Side: Home Icon (Hidden on Home Page) */}
        <AnimatePresence>
          {pathname !== "/" && (
            <motion.div 
            ...
            >
              <Link href="/" className="flex items-center justify-center p-2 mr-2 rounded-full hover:bg-black/5 dark:hover:bg-white/10 transition-colors group/home" title="Go to Home">
        ...
        {/* 💻 Right Side: Terminal Icon (Always Visible + Active State Logic) */}
          ...
          <Link 
            ...
            className={`flex items-center justify-center p-2 ml-2 rounded-full transition-all duration-300 group/term ${
              pathname === "/terminal" || pathname.startsWith("/terminal/") 
                ? "bg-white dark:bg-[#222] shadow-sm border border-gray-200/50 dark:border-gray-700/50" 
