...
// 📌 WhatsApp Custom SVG Icon (Added className prop for responsiveness)
...
// 📌 Messenger Custom SVG Icon (Added className prop for responsiveness)
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* 📌 MENU VIEW - Mobile Optimized Typography & Icons */}
            {viewMode === "menu" && (
                ...
                <div className="p-4 sm:p-5 flex flex-col gap-4 sm:gap-5 bg-white dark:bg-[#050505]">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-3.5">
                    <a 
                      ...
                      className="group relative overflow-hidden flex flex-col items-center justify-center p-3.5 sm:p-4 rounded-xl bg-gray-50 dark:bg-[#111] border border-gray-200/80 dark:border-gray-800 shadow-sm hover:shadow-md hover:border-green-500/50 dark:hover:border-green-500/50 transition-all"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="group relative overflow-hidden flex flex-col items-center justify-center p-3.5 sm:p-4 rounded-xl bg-gray-50 dark:bg-[#111] border border-gray-200/80 dark:border-gray-800 shadow-sm hover:shadow-md hover:border-blue-500/50 dark:hover:border-blue-500/50 transition-all"
                    >
                  ...
                  <div className="relative flex items-center py-0.5 sm:py-1">
                    ...
                    <span className="flex-shrink-0 mx-4 text-gray-400 dark:text-gray-600 text-[9px] sm:text-[10px] uppercase tracking-widest font-bold">Or Ask AI</span>
                    <div className="flex-grow border-t border-gray-200 dark:border-gray-800"></div>
                  </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 sm:gap-3.5 relative z-10">
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-[10px] sm:text-[11px] text-gray-300 dark:text-gray-600 font-medium mt-0.5">Smart Assistant • 24/7</span>
                      </div>
                    </div>
